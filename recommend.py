...
def find_centroid(cluster):
    ...
    # BEGIN Question 5
    "*** YOUR CODE HERE ***"
    locat=[restaurant_location(rest) for rest in cluster]
    return [mean([x[0]for x in locat]),mean([x[1] for x in locat])]
    # END Question 5
...
def k_means(restaurants, k, max_updates=100):
    ...
    while old_centroids != centroids and n < max_updates:
        ...
        # BEGIN Question 6
        "*** YOUR CODE HERE ***"
        new_restaurants=group_by_centroid(restaurants,centroids)
        centroids=[find_centroid(group) for group in new_restaurants]
        # END Question 6
        n += 1
    return centroids
################################
...
def best_predictor(user, restaurants, feature_fns):
    ...
    for i in feature_fns:
        ...
        lst.append(b)
        other_lst.append(a)
    return other_lst[lst.index(max(lst))]
    """
    lst=[]
    for i in feature_fns:
        a,b=find_predictor(user, reviewed,i)
...
def rate_all(user, restaurants, feature_fns):
    ...
    for i in restaurants:
        ...
        if i in reviewed:
            new_dic[name]=user_rating(user,name)
        else:
            new_dic[name]=predictor(i)
    return new_dic
    # END Question 9
